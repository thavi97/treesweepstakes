...
<div class="split split-one">
  ...
  <div class="round round-two">
    ...
    <ul class="matchup">
      <li class="team team-top"><img src="img/4x3/fr.svg"/ style="width:20px; height: auto; float:left; margin: 5px 5px 0 0;">Alan<span class="score">3</span></li>
      <li class="team team-bottom"><img src="img/4x3/ch.svg"/ style="width:20px; height: auto; float:left; margin: 5px 5px 0 0;">Izzy<span class="score">3</span></li>
    </ul>
    <ul class="matchup">
